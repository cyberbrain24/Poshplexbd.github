...
const ProductReviews = dynamic(() => import('./ProductReviews'), { loading: () => <p style={{fontSize: 13, textAlign: 'center', padding: '20px 0', color: '#888'}}>Loading reviews...</p>, ssr: false });
...
export default function ProductDetailClient({ 
  ...
  /* reviews count for accordion badge */
              ...
              <div key={key} style={{ borderBottom: "1px solid #eee" }}>
                ...
                {isOpen && (
                  <div className="accordion-content-box" style={{ paddingBottom: 20 }}>
                    ...
                    {/* Reviews section */}
                    {key === "reviews" && (
                      <ProductReviews product={product} initialReviews={initialReviews} setLightboxUrl={setLightboxUrl} />
                    )}
                  </div>
                )}
              </div>
